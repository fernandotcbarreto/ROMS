...
######################################################################
#
Yorig         = 2013;               # reference time for vector time
                                    # in roms initial and forcing files
#
Ymin          = 2020;               # first forcing year
Ymax          = 2013;               # last  forcing year
Mmin          = 4;                  # first forcing month
Mmax          = 6;                  # last  forcing month
#
Dmin          = 8;                  # Day of initialization
...
input_path='C:/Users/Fernando/Desktop/prooceano_roms/atm_gfs/data/'

output_path = 'C:/Users/Fernando/Desktop/prooceano_roms/ATM/output/'