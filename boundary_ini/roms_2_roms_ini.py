...
plt.plot(x_fm,y_fm, 'red')
plt.plot(x_roms,y_roms, 'blue');plt.show()
...
for rt in range(1):     #only interpolate first time

  print('interpolation time ' +  str(rt))
  ...
  z_fm = z_parent[:,-1,-1]    ### just for input in routine, not used in computation
